...
const DeleteCommitmentService_1 = require("../../services/commitments/DeleteCommitmentService");
class DeleteCommitmentController {
    handle(request, reply) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const commitmentService = new DeleteCommitmentService_1.DeleteCommitmentService();
            try {
                yield commitmentService.execute({ id });
